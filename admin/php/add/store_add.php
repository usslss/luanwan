...
<div class="x-body">
 <form action="store_add_finish.php" method="post" enctype="multipart/form-data">
                
                <table class="layui-table" >
                    <tbody >                                               
                        <tr>
                            <th colspan="1" width="100">门店名称</th>
                            <td colspan="1" width="300"><div class="layui-input-inline">
                  <input type="text" style="width:400px" name="store_name" required="" lay-verify="required" autocomplete="off" class="layui-input"></td>
                  <td colspan="1" width="50">网站</td>
                  <td colspan="1">                  
                  <select name='store_website' >
                  ...
                  <input type="text" style="width:400px" name="store_address" required="" lay-verify="required"
                  autocomplete="off" class="layui-input"  value="">
                        ...
                        <tr>
                            <th colspan="1" valign="top">门店简介</th>
                 ...
                 <input class="layui-btn" type="submit" name="传值" value="添加门店" />
