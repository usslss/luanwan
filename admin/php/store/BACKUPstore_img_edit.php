...
<div class="x-body">
 <form action="img_edit_finish.php" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" value="<?php echo $img_id;?>" name="img_id"></input>        
                        ...
                        <tr>
                            ...
                            <a href="javascript:DataHtml('PC端配图.jpg','../../qlhht/<?php echo $store_img_url;?>')">
　　<img id="imgHeadPhoto" alt='PC端配图.jpg' title='PC端配图.jpg' style='width:100px' src='../../../<?php echo $store_img_url;?>'/>
</div>
</a>
                        ...
                        <tr>
                            ...
                            <div id="divPreview">
                            <img id="imgHeadPhoto" src="../../../<?php echo $store_wap_img_url;?>" style="width: 300px; height: 100px; border: solid 1px #d2e2e2;" alt="" />
                            </div>
