...
<div class="x-body">
 <form action="store_img_edit_finish.php" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" value="<?php echo $store_id;?>" name="store_id"></input>        
                        ...
                        <tr>
                            ...
                            <div id="divPreview">
                             <img id="imgHeadPhoto1" src="../../../<?php echo $store_img_url;?>" style="width: 300px; height: 100px; border: solid 1px #d2e2e2;" alt="" />
							</div>
                        ...
                        <tr>
                            ...
                            <div id="divPreview">
                            <img id="imgHeadPhoto2" src="../../../<?php echo $store_wap_img_url;?>" style="width: 300px; height: 100px; border: solid 1px #d2e2e2;" alt="" />
                            </div>
