...
if(isset($file_url))
{
    ...
    $sql_img = "UPDATE img SET img_name='{$filename_gbk}', img_url='{$img_url}', img_text='{$img_text}', img_class='{$img_class}',img_source='{$img_source}' WHERE img_id='{$img_id}'";
    
}
else{
    $sql_img = "UPDATE img SET img_text='{$img_text}', img_class='{$img_class}',img_source='{$img_source}' WHERE img_id='{$img_id}'";
}



$sqlfinish = mysqli_query($link,$sql_img);
