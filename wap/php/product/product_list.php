...
?>
				<a class="prev" href="<?php echo "product.php?class=" . $showProductClass . "&page=1"; ?>">首页</a>
...
?>
					...
					<a href="<?php echo "product.php?class=" . $showProductClass . "&page=" . $page_max; ?>" class="next">尾页</a>						
				</div>